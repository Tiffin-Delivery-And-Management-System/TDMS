...
import AddCustomerAddressModal from "../register/AddCustomerAddressModal";
...
function ProfilePage() {
 ...
 const [addresses, setAddressesS] = useState([]); // To store addresses
 ...
 const handleAddAddress = (newAddress) => {
  ...
  dispatch(setAddresses([...address, newAddress])); // Add the new address to the Redux store

  console.log("Addresses from Redux store:", address); // Add this to debug
    ...
    <div className="row">
     <div className="sidebar">
      <div className="sidebar-options">
       <div
        className={`sidebar-option ${activeTab === "profile" ? "active" : ""}`}
        onClick={() => handleTabClick("profile")}
       >
        <img src={assets.user} alt="Customer Profile" />
        <p>View Profile</p>
       </div>
       <div
       ...
       >
        <img src={assets.list_icon} alt="Customer Orders List" />
        <p>Your Orders</p>
       </div>
       <div
        className={`sidebar-option ${activeTab === "address" ? "active" : ""}`}
        onClick={() => handleTabClick("address")}
       >
        <img src={assets.book_a} alt="Customer Address Book" />
        <p>Address Book</p>
       </div>
      </div>
     </div>
     <div className="col">
      <h1 className="name">Welcome {name} to Dabbewala</h1>
            ...
            {orders.map((order, index) => (
             <tr key={order.id}>
              ...
              {/* <td>
               ...
               >
                {submittedReviews[order.id] ? "Submitted" : "Review"}
               </button>
              </td> */}
             </tr>
            ))}
