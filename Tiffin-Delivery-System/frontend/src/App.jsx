...
import Vendorslist from "./customer/pages/customerHome";
import CustomerLayout from "./customer/layouts/customerLayouts";
...
import ChatWindow from "./DeliveryBoy/components/ChatWindow";
  ...
  <div className="App">
   ...
   <Routes>
    ...
    <Route element={<DbLayout />}>
     ...
     <Route path="/dbchat" element={<ChatWindow />} />
    </Route>

    <Route element={<CustomerLayout />}>
     {/* <Route path="/customerhome" element={<CustomerHomePage />} /> */}
     <Route path="/customerHome" element={<Vendorslist />} />
     <Route path="/ProfilePage" element={<ProfilePage />} />
    </Route>
   </Routes>
